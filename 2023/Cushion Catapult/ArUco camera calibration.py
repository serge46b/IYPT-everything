...
CALIB_FILE_PATH = ROOT + "calibration.json"
CALIB_IMG_ARRAY_PATH = ROOT + "calibration images/"

CALIB_ARUCO_DCT = aruco.DICT_4X4_1000
MARKER_SIZE = 0.045  # units - meters
MARKER_SEP = 0.003  # units - meters
BOARD_SIZE_X = 4
BOARD_SIZE_Y = 5
GNERATE_BOARD_MODE = True
